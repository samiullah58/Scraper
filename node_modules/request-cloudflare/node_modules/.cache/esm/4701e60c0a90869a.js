let vm,requestModule,Debug;_0a9‍.x([["requestCloudflare",()=>requestCloudflare],["default",()=>requestCloudflare]]);_0a9‍.w("vm",[["default",["vm"],function(v){vm=v}]]);_0a9‍.w("request",[["default",["requestModule"],function(v){requestModule=v}]]);_0a9‍.w("debug",[["default",["Debug"],function(v){Debug=v}]]);
...
function solveChallenge(response, body, options, callback) {
  setTimeout(()=>{
    ...
    try {
      options.qs.jschl_answer = (_0a9‍.u(eval(_0a9‍.c(challenge))) + response.request.host.length);
    } catch (err) {
